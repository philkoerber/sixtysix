    ...
    <div className="welcomewrapper">
      <Box fontFamily="bodyFont">
        ...
        <motion.div
          ...
          initial={{ scale: 0 }}
          animate={
            animationIndex > 1 ? { rotate: -6, scale: 1, x: "-20%" } : {}
          }>
          <Text textShadow="1px 1px 3px #000000" fontSize={[18, 20]}>
            Dont know the Rules?
          </Text>
          <Text textShadow="1px 1px 3px #000000" fontSize={[35, 40]}>
            Read the Rules...
          </Text>
        </motion.div>
        ...
        <Modal isOpen={isOpen} onClose={onClose} scrollBehavior="inside">
          ...
          <ModalContent
            ...
            <ModalFooter bg="alpha.200" backdropFilter="blur(10px)">
              <Button onClick={handleStartButton} variant="blackAlpha">
                Start the game
              </Button>
            </ModalFooter>
          </ModalContent>
        ...
        <motion.div
          ...
          animate={
            animationIndex > 2
              ? { rotate: 12, scale: 1, x: "25%", y: "20%" }
              : {}
          }
          onClick={() => {
            const websiteLink = "https://philippkoerber.netlify.app/"; // Replace with your desired link
            window.open(websiteLink, "_blank"); // Opens the link in a new tab/window
          }}>
          <Text textShadow="1px 1px 3px #000000" fontSize={[15, 20]}>
            You like the App?
          </Text>
          <Text textShadow="1px 1px 3px #000000" fontSize={[30, 40]}>
            Contact me...
          </Text>
        </motion.div>
      </Box>
